        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#process" className="text-muted-foreground hover:text-accent transition-colors">How It Works</a></li>
              <li><a href="#gallery" className="text-muted-foreground hover:text-accent transition-colors">Gallery</a></li>
